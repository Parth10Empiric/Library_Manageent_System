...
urlpatterns = [
    ...
    path('authors/<int:author_id>/detail/', views.author_detail, name='author_detail'),
    ...
    path("fines/<int:fine_id>/update-amount/", views.update_fine_amount, name="update_fine_amount"),
